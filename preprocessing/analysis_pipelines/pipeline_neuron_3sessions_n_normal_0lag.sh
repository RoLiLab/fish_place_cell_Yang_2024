...
if $RERUN = true
then
    julia combine_rois_0lag.jl $DATASET_NAME_1 $SERVER_1 $EXPERIMENTER -a $ANALYZER
    julia combine_rois_known_0lag.jl $DATASET_NAME_1 $SERVER_1 $DATASET_NAME_2 $SERVER_2 $EXPERIMENTER -a $ANALYZER
    julia combine_rois_known_0lag.jl $DATASET_NAME_1 $SERVER_1 $DATASET_NAME_3 $SERVER_3 $EXPERIMENTER -a $ANALYZER
